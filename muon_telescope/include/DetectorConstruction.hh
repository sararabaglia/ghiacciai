...
public:
  ...
  G4LogicalVolume*   GetLvolSubFiber()      {return lvol_subfiber;};
  ...
  G4LogicalVolume*   GetLvolMountain()      {return lvol_mountain;};
  G4LogicalVolume*   GetLvolIce()           {return lvol_ice;};
  G4LogicalVolume*   GetLvolIceTop()        {return lvol_ice_top;};
  ...
  G4int              GetNbDetector()        {return nbDetectors;};
...
private:
  ...
  // 
  G4Material*      fiberMat;
  G4double         subFiberDiameter;
  G4LogicalVolume* lvol_subfiber;
  ...
  //mountain
  //
  G4Material*      mountainMat;
  G4LogicalVolume* lvol_mountain;
  
  //ice
  //
  G4Material*      iceMat;
  G4LogicalVolume* lvol_ice;
  G4LogicalVolume* lvol_ice_top;
