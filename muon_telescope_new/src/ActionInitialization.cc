...
ActionInitialization::ActionInitialization(DetectorConstruction* det, G4String Id)
 : G4VUserActionInitialization(),fDetector(det), Identity(Id)
{ }
...
void ActionInitialization::Build() const
{
  ...
  EventAction* eventaction = new EventAction(fDetector,primary, Identity);
